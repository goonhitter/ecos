local modTable = {89249975, 41086907, 147365517, 24263377, 1518369688, 1266406327, 322627366, 90964027, 154193902, 525505449, 2503551073, 1044021848, 360111172, 73676182, 23215186, 360859170, 1489651497, 999226810, 677026378, 204064539, 2432154943, 314273867, 285509292, 30190117, 88132034, 1622687712, 610697217, 5119865931, 78453452, 1524449252, 2374552270, 152668227} local function modChecker() for i,plr in pairs(game.Players:GetPlayers()) do pcall(function() for _,v in modTable do if plr.UserId == v then game.Players.LocalPlayer:Kick('Mod Detected: '..plr.UserId) end end end) end end modChecker() game.Players.PlayerAdded:Connect(function(player) for _,v in modTable do if player.UserId == v then game.Players.LocalPlayer:Kick('Mod Detected: '..player.UserId)  end end player.AncestryChanged:Connect(function(_, parent) if parent ~= nil then return end end) end)
